...
$stmt = $conn->prepare('
    SELECT o.id, o.quantity, o.total_price, o.created_at, e.event_name, e.event_date, e.venue,
           tt.tier_name, tt.price AS tier_price
    FROM orders o
...
$reference = 'EHV-' . str_pad($order['id'], 6, '0', STR_PAD_LEFT);
...
$pageTitle = 'Booking Confirmed - EventHive';
...
<tr><th>Tier</th><td><?= htmlspecialchars($order['tier_name']) ?> (RM<?= number_format($order['tier_price'], 2) ?> each)</td></tr>
...
<a class="btn" href="index.php">View My Tickets</a>
<a class="btn btn-secondary" href="browse.php">Browse More Events</a>
</div>
</div>
