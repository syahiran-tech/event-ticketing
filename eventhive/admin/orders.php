...
$orders = $conn->query('
    SELECT o.id, e.event_name, tt.tier_name, o.quantity, o.total_price, u.name AS user_name, u.email AS user_email,
    ...
    GROUP BY o.id, e.event_name, tt.tier_name, o.quantity, o.total_price, u.name, u.email
    ORDER BY o.created_at DESC
')->fetch_all(MYSQLI_ASSOC);

$pageTitle = 'All Reservations - EventHive Admin';
...
<?php else: ?>
<table>
<tr><th>Event</th><th>Tier</th><th>Qty</th><th>Total (RM)</th><th>Booked By</th><th>Email</th><th>Checked In</th><th>Actions</th></tr>
...
<td>
<form action="order_cancel.php" method="post" style="display:inline" onsubmit="return confirm('Cancel this reservation?');">
