...
$pageTitle = 'Manage Users - EventHive Admin';
...
<form action="user_delete.php" method="post" style="display:inline" onsubmit="return confirm('Delete this user? This will PERMANENTLY delete their account together with ALL of their reservations (restoring ticket inventory) and testimonials. This cannot be undone.');">
<input type="hidden" name="id" value="<?= (int)$u['id'] ?>">
