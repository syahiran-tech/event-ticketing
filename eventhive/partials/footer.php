...
<div class="footer-brand-name">EventHive</div>
<p>Book Regular or VIP tickets for campus club and society events &mdash; cultural nights, band battles, charity dinners and more.</p>
</div>
...
<div class="footer-links">
<h4>Contact</h4>
<p>TAR UMT Student Societies Office<br>Student Centre, Level 1</p>
<p>+60 3-4145 0450</p>
</div>
</div>
<div class="footer-bottom">
<p>&copy; <?= date('Y') ?> EventHive &middot; run by the TAR UMT Student Societies Office &middot; AMIT3253 Sample Project</p>
</div>
</footer>
